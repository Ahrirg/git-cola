...
def format_exception(exc) -> tuple[str | UStr | None, str]:
    ...
    if hasattr(exc, 'msg'):
        msg: str | UStr | None = exc.msg
    else:
        msg: str | UStr | None = core.decode(repr(exc))
    return (msg, details)
...
def _shell_split_py2(value) -> list[UStr | None]:
